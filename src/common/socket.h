...
{
    //raw callback types
    typedef std::function<void (const Socket& socket, uint32_t bytes_transferred)> SendCallback;
    typedef std::function<void (const Socket& socket, const byte* data, uint32_t bytes_transferred)> ReceiveCallback;
    typedef std::function<void (const Socket& socket)> ConnectedCallback;
    typedef std::function<void (const Socket& connection)> CloseCallback;
